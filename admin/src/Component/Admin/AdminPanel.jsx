  ...
  const AdminPanel = () => {
    ...
    const fetchTopProducts = async () => {
      try {
        setLoading(true);
        const response = await axios.get('https://pdfbazaar.onrender.com/api/products/top');
    ...
    try {
     const response = await axios.get('https://pdfbazaar.onrender.com/api/dashboard/stats');
